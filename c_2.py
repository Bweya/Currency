...
workbook = xlsxwriter.Workbook(str(year)+'currency.xlsx')
...
worksheet.merge_range('A1:F1', 'FX Trades by Currency 01 JAN - 31 DEC '+str(year), bolds)
    ...
    for file in files:
        ...
        if file[:3] == '.DS' or file[:1] == 't':
            ...
            for y in TradeData[6]:
                ...
                index += 1
    valueAdd.append(valueadd_bp)



#==========================================================================

valueAdd.sort(reverse = True)
v = valueAdd
appendcurr = []
...
for val in v:
    ...
    for curr in check_curr:
        ...
        if val == valueadd_bp and curr not in appendcurr:

            appendcurr.append(curr)
            ...
            #if curr not in appendcurr == True:
